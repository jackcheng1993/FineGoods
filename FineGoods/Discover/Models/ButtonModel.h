...
@interface DynamicModel1 : JSONModel
...
@interface AuthorModel1 : JSONModel
...
@property (nonatomic, strong) DynamicModel1 *dynamic;
@property (nonatomic, strong) NSMutableArray<ProductModel> *product;
@property (nonatomic, strong) AuthorModel1 *author;
